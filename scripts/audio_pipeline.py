...
for fn in fn_times[:5]:
    ...
    print("Closest refined center:", best_c)
    print("Offset:", best_diff)

# =============================
# SAVE WHISTLES TO JSON
# =============================

output_path = f"{MATCH_ID}_predicted_whistles.json"

whistle_data = []

for i, t in enumerate(cnn_centers):
    whistle_data.append({
        "match_id": MATCH_ID,
        "whistle_id": i,
        "time": float(t)
...
with open(output_path, "w") as f:
    json.dump(whistle_data, f, indent=2)

print("\nSaved whistles to:", output_path)
